...
export default function ProductCard({ id, name, price, rawPrice, imageUrl }: ProductCardProps) {
  ...
  return (
    <div className="bg-mono-bg rounded-2xl p-4 lg:p-5 shadow-neo-sm hover:shadow-neo transition-all duration-300 flex flex-col group cursor-pointer">
      <div className="relative w-full aspect-square rounded-xl mb-4 lg:mb-5 overflow-hidden flex items-center justify-center p-0">
        ...
        <button 
          ...
          className="absolute top-2 right-2 lg:top-3 lg:right-3 w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-mono-bg shadow-neo-sm hover:shadow-neo-inset flex items-center justify-center text-mono-text transition-all z-10"
        >
